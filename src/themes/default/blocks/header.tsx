              ...
              return (
                <NavigationMenuLink key={idx} asChild>
                  <Link
                    ...
                    className={`flex flex-row items-center gap-2 rounded-md px-3 py-2 text-sm font-medium text-zinc-700 transition hover:bg-zinc-100 hover:text-zinc-950 ${
                  ...
                  {header.buttons &&
                    header.buttons.map((button, idx) => (
                      <Link
                        ...
                        className={cn(
                          'focus-visible:ring-ring inline-flex items-center justify-center gap-2 rounded-md text-sm font-semibold whitespace-nowrap transition focus-visible:ring-1 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
                          'h-10 px-4 ring-0',
                          button.variant === 'outline'
                            ? 'border border-zinc-200 bg-white text-zinc-950 shadow-sm shadow-zinc-900/5 hover:bg-zinc-50'
                            : 'border border-zinc-950 bg-zinc-950 text-white shadow-md shadow-zinc-900/15 hover:-translate-y-0.5 hover:bg-zinc-800 active:translate-y-0'
                        )}
                      >
                        {button.icon && (
                          <SmartIcon
