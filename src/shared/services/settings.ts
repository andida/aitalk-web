...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      ...
      title: t('groups.cloudflare_email'),
      description: 'custom your transactional email settings',
      tab: 'email',
    },
    {
      name: 'r2',
      title: t('groups.r2'),
      description: 'custom your object storage settings',
      tab: 'storage',
    },
    {
      name: 'openrouter',
...
export async function getSettings() {
  const settings: Setting[] = [
    ...
    },
    {
      ...
      group: 'email_auth',
      tab: 'auth',
      tip: 'Require users to verify their email before they can sign in. Requires transactional email sender configuration.',
    },
    {
  ...
  "premium-yearly": "prod_xxx"
    ...
    {
      name: 'cloudflare_email_enabled',
      title: 'Transactional Email Enabled',
      type: 'switch',
      value: 'true',
      group: 'cloudflare_email',
      tab: 'email',
      tip: 'Send transactional emails through the configured email binding.',
    },
    {
      name: 'cloudflare_email_binding',
      title: 'Email Binding',
      type: 'text',
      value: 'EMAIL',
      placeholder: 'EMAIL',
      group: 'cloudflare_email',
      tab: 'email',
      tip: 'Must match the configured transactional email binding name.',
    },
    {
      name: 'cloudflare_email_sender',
      title: 'Email Sender',
      type: 'text',
      placeholder: 'SiteRise <no-reply@email.siterisehq.com>',
      group: 'cloudflare_email',
      tab: 'email',
      tip: 'Use a verified sender address.',
    },
    {
      name: 'resend_api_key',
